...
import { useClientLogin } from "@/services/client-auth/client-auth.hooks";
import type { ClientLoginSchemaType } from "@/services/client-auth/client-auth.schema";
...
export function ClientLoginForm({
  ...
  const { setToken } = useClientAuthStore();
  ...
  function onSubmit(data: LoginFormValues) {
    ...
    loginMutation.mutate(data as ClientLoginSchemaType);
  }
