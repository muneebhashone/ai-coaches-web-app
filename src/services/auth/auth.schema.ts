...
export const registerCoachByEmailSchema = z
  .object({
    expertise: z.string({ required_error: "Expertise is required" }).min(1),
...
export type RegisterCoachByEmailSchemaType = z.infer<
  typeof registerCoachByEmailSchema
>;
