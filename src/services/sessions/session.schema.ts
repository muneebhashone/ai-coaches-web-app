...
export const UpdateSessionSchema = z.object({
  ...
  status: z.enum(Object.values(SessionStatusEnum) as [string, ...string[]]).optional(),
...
export type CreateMultipleSessionsSchemaType = z.infer<typeof CreateMultipleSessionsSchema>;
